...
/**/
                    ...
                    if ((parseInt(aDataCnf[0].codMat) > 0) && data[i].chk == true && data.length > 1) {
                        if (aDataCnf[0].swR) {
                            tabla += '<td style="text-align:center;background:#000000;"> <a href="#" class="btn" style="cursor: pointer;font-size:small;" data-toggle="modal" data-target="#continuemodal" onclick="fnEliminarConfirmar(' + data[i].cod_Dmat + ',' + data[i].codigo_cur + ',\'' + data[i].nombre_Cur + '\',\'¿Deseas retirarte del curso \'' + ')"><i class="ion-android-cancel"></i></a></td>';
                        } else {
                            tabla += '<td></td>';
                        }
        ...
        $('#tablagruposdisponibles tbody td.details-control').on('click', function() {
            ...
            if (oTable.fnIsOpen(nTr)) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        console.log(data);
                        sOut = '<table class="display" cellpadding="1" cellspacing="1" style="width:100%;font-size:11px;border: 1px #000000 solid;">';
                        var c;
                        var _null;
                        if (data.length > 0) {
                                        ...
                                        if (data[i].codigo_cup != data[i + 1].codigo_cup) {
                                            ...
                                            if (data[i].estado_cup && parseInt(data[i].vacantes_cup) > parseInt(data[i].nromatriculados)) {
                                                if (fnBuscarData(data[i].codigo_cur, "selC", "") == data[i].codigo_cup) {
                                                    sOut += '<input type="button" id="btnCurso' + data[i].codigo_cup + '" name="btnCurso' + data[i].codigo_cur + '"  onclick="fnSeleccionar(' + data[i].codigo_cup + ',' + data[i].codigo_cur + ')" style="background-color:#000000;"/>';
                                                } else {
                                                ...
                                                if (parseInt(data[i].cup_Mat) == parseInt(data[i].codigo_cup)) {
                                                    sOut += '<input type="button" id="btnCurso' + data[i].codigo_cup + '" name="btnCurso' + data[i].codigo_cur + '"  onclick="fnSeleccionar(' + data[i].codigo_cup + ',' + data[i].codigo_cur + ')" style="background-color:#000000;" readonly="readonly"/>';
                                                }
                                            }
                                            sOut += '</td>';
                                ...
                                if (cadcup.indexOf(data[data.length - 1].codigo_cup) == -1) {
                                    ...
                                    if (data[data.length - 1].estado_cup && parseInt(data[data.length - 1].vacantes_cup) > parseInt(data[data.length - 1].nromatriculados)) {
                                        if (fnBuscarData(data[data.length - 1].codigo_cur, "selC", "") == data[data.length - 1].codigo_cup) {
                                            sOut += '<input type="button" id="btnCurso' + data[data.length - 1].codigo_cup + '" name="btnCurso' + data[data.length - 1].codigo_cur + '"  onclick="fnSeleccionar(' + data[data.length - 1].codigo_cup + ',' + data[data.length - 1].codigo_cur + ')" style="background-color:#000000;"/>';
                                        }
                                        else {
                                        ...
                                        if (parseInt(data[data.length - 1].cup_Mat) == parseInt(data[data.length - 1].codigo_cup)) {
                                            sOut += '<input type="button" id="btnCurso' + data[data.length - 1].codigo_cup + '" name="btnCurso' + data[data.length - 1].codigo_cur + '"  onclick="fnSeleccionar(' + data[data.length - 1].codigo_cup + ',' + data[data.length - 1].codigo_cur + ')" style="background-color:#000000;" readonly="readonly"/>';
                                        }
                                    }
...
//                nap++;
    ...
    function fnSeleccionar(ccup, ccur) {             
        ...
        if (selCurso == ccup) {
            ...
            $('#' + ccur).css("background-color", "#000000");

            $("input[name=btnCurso" + ccur + "]").css("background-color", "");
            $("input[id=btnCurso" + ccup + "]").css("background-color", "#000000");
