...
Partial Class RepPublicaciones
    ...
    Protected Sub btnExportarRep_ServerClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExportarRep.ServerClick
        ...
        Response.AddHeader("Content-Disposition", "attachment; filename=RepPublicaciones.xls")
    ...
    Private Function HTML() As String
        ...
        oePublicacion.anio_pub = fn.DecrytedString64(Me.cboAnio.Value)
        Grid.DataSource = olPublicaciones.ReportePublicaciones2(oePublicacion)
