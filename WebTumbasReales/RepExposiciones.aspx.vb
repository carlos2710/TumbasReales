...
Partial Class RepExposiciones
    ...
    Private Function HTML() As String
        ...
        oeExposicion.param1 = 2018 'fn.DecrytedString64(Me.cboAnio.Value)
        Grid.DataSource = olExposiciones.ReporteExposicionesAnio2(oeExposicion)
